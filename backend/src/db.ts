...
export class DatabaseManager {
  ...
  public async initTables() {
    ...
    await this.query(`ALTER TABLE crm_contacts ADD COLUMN platform TEXT DEFAULT 'whatsapp'`).catch(() => {});
    ...
    await this.query(`ALTER TABLE crm_chats ADD COLUMN platform TEXT DEFAULT 'whatsapp'`).catch(() => {});
