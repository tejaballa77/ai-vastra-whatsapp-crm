...
session_id = "test_transition_" + uuid.uuid4().hex[:8]
conv_id = None

convo = [
    "I want to buy the pro plan and kiosk machin",
    "ok kiosk will be contacted by your team, then how can i try this virtual tryon can i try this on my phone"
]
